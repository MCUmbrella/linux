...
static struct exception_info iexcept_table[10] = {
	{ "Oof - instruction fetch", SIGBUS, BUS_ADRERR },
	{ "Oof - fetch packet", SIGBUS, BUS_ADRERR },
	{ "Oof - execute packet", SIGILL, ILL_ILLOPC },
	{ "Oof - undefined instruction", SIGILL, ILL_ILLOPC },
	{ "Oof - resource conflict", SIGILL, ILL_ILLOPC },
	{ "Oof - resource access", SIGILL, ILL_PRVREG },
	{ "Oof - privilege", SIGILL, ILL_PRVOPC },
	{ "Oof - lOof buffer", SIGILL, ILL_ILLOPC },
	{ "Oof - software exception", SIGILL, ILL_ILLTRP },
	{ "Oof - unknown exception", SIGILL, ILL_ILLOPC }
};

/* External exceptions */
static struct exception_info eexcept_table[128] = {
	{ "Oof - external exception", SIGBUS, BUS_ADRERR },
	{ "Oof - external exception", SIGBUS, BUS_ADRERR },
	{ "Oof - external exception", SIGBUS, BUS_ADRERR },
	{ "Oof - external exception", SIGBUS, BUS_ADRERR },
	{ "Oof - external exception", SIGBUS, BUS_ADRERR },
	...
	{ "Oof - external exception", SIGBUS, BUS_ADRERR },
	{ "Oof - external exception", SIGBUS, BUS_ADRERR },
	{ "Oof - CPU memory protection fault", SIGSEGV, SEGV_ACCERR },
	{ "Oof - CPU memory protection fault in L1P", SIGSEGV, SEGV_ACCERR },
	{ "Oof - DMA memory protection fault in L1P", SIGSEGV, SEGV_ACCERR },
	{ "Oof - CPU memory protection fault in L1D", SIGSEGV, SEGV_ACCERR },
	{ "Oof - DMA memory protection fault in L1D", SIGSEGV, SEGV_ACCERR },
	{ "Oof - CPU memory protection fault in L2", SIGSEGV, SEGV_ACCERR },
	{ "Oof - DMA memory protection fault in L2", SIGSEGV, SEGV_ACCERR },
	{ "Oof - EMC CPU memory protection fault", SIGSEGV, SEGV_ACCERR },
	{ "Oof - EMC bus error", SIGBUS, BUS_ADRERR }
};
